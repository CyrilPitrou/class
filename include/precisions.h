...
class_precision_parameter(start_small_omega_tau,double,0.001) /**< value of omega*tau which gives an upper value for the starting tau when integrating vector modes. Decrease to start earlier in time*/
...
class_precision_parameter(l_max_g_vec,int,10)     /**< number of momenta in Boltzmann hierarchy for photon temperature (vector), at least 4 (incremented by 1 inside the code when using tam hierarchy instead of optimal) */
class_precision_parameter(l_max_pol_g_vec,int,10) /**< number of momenta in Boltzmann hierarchy for photon polarization (vector), at least 4 (incremented by 1 inside the code when using tam hierarchy instead of optimal) */
